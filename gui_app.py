# Here we use GUI code for create desktop application :
# GUI >> use package >> tkinter
...
def estimate(s):  # estimate use for predict good or bad  and store the user's review  and save result..
    model=load_model('Lstm_resturant_review_pred.keras')
    ...
    conn=pymysql.connect(user='root',password='Ravi@1998',
